...
void Button::draw()
{
  ...
  glEnd();
  if ( ButtonIsPressed ) glColor3f(1., 1., 0.);
  else if ( overButton ) glColor3f(.5, .5, .5);
...
{
  ButtonIsPressed = newVal;
}

void Button::setoverButton(bool newVal)
{
  overButton = newVal;
}
...
bool Button::getButtonIsPressed()
{
